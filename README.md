...
This application uses [sdk-spotify](https://github.com/lflimeira/sdk-spotify) library to get informations and musics from Spotify. 
...
We use [SemVer](http://semver.org/) for versioning. For the versions available, see the [tags on this repository](https://github.com/lflimeira/spotify-player/tags).

## Authors

| ![Willian Justen](https://avatars2.githubusercontent.com/u/7549765?v=3&s=150)|
|:---------------------:|
|  [Luiz Felipe Limeira](https://github.com/lflimeira/)   |

See also the list of [contributors](https://github.com/lflimeira/spotify-player/contributors) who participated in this project.
